...
\begin{center}
    ...
    \begin{tikzpicture}[node distance=4cm, ->, >=stealth', shorten >=1pt, auto, thick]
        ...
        \draw [black!15, dashed, swap]
            ...
            (l2) edge [out=210, in=285, looseness=1.2, swap, pos=0.5] node {\click} (off)
        ...
        \begin{scope} [black!40]
            ...
            \draw
                ...
                (l1) edge [out=0, in=180, pos=0.2] node {\click\click\click\click\click\click} (progl3)
            ...
            \draw [black!15, dashed]
                ...
                (progh2) edge [-, out=180, in=30, pos=0.3] node {\click} (j1)

                (progm1) to [out=180, in=30, pos=0.3] node {\click} (10,-7) coordinate (j2) to [out=210, in=270, looseness=1.17] (off)
                (progm2) edge [-, out=180, in=30, pos=0.3] node {\click} (j2)

                (progl1) to [out=180, in=30, pos=0.3] node {\click} (17,-6.5) coordinate (j3) to [out=210, in=270, looseness=1.2] (off)
                (progl2) edge [-, out=180, in=30, pos=0.3] node {\click} (j3)
            ;
        \end{scope}
